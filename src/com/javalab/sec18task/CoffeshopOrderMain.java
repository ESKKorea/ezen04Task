...
public class CoffeshopOrderMain {
    public static void main(String[] args) {
        ...
        for (ProductDate pdd : productdates) {
            if (pdd.getProductCategory() == categoryId) {
        ...
        String productName = findProductName(productId, productdates);
        System.out.println("상품명 : " +productName + " 수량 : " + quantity + " 담당사원 " + randomEmployee.getName());
